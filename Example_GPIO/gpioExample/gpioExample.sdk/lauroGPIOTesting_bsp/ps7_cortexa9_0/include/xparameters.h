...
/* Definitions for peripheral LAUROLED */
#define XPAR_LAUROLED_BASEADDR 0x41210000
#define XPAR_LAUROLED_HIGHADDR 0x4121FFFF
#define XPAR_LAUROLED_DEVICE_ID 0
#define XPAR_LAUROLED_INTERRUPT_PRESENT 0
#define XPAR_LAUROLED_IS_DUAL 0


/* Definitions for peripheral LAUROPUSHBUTTON */
#define XPAR_LAUROPUSHBUTTON_BASEADDR 0x41200000
#define XPAR_LAUROPUSHBUTTON_HIGHADDR 0x4120FFFF
#define XPAR_LAUROPUSHBUTTON_DEVICE_ID 1
#define XPAR_LAUROPUSHBUTTON_INTERRUPT_PRESENT 0
#define XPAR_LAUROPUSHBUTTON_IS_DUAL 0


/******************************************************************/

/* Canonical definitions for peripheral LAUROLED */
#define XPAR_GPIO_0_BASEADDR 0x41210000
#define XPAR_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_LAUROLED_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral LAUROPUSHBUTTON */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_LAUROPUSHBUTTON_DEVICE_ID
