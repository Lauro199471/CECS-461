...
//Date        : Sun Apr 08 19:53:52 2018
//Host        : Lauro-Laptop running 64-bit major release  (build 9200)
//Command     : generate_target hardware_linux.bd
//Design      : hardware_linux
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "hardware_linux,IP_Integrator,{x_ipProduct=Vivado 2015.2,x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=hardware_linux,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,da_ps7_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "hardware_linux.hwdef" *) 
module hardware_linux
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  GND GND
       (.G(GND_1));
  hardware_linux_processing_system7_0_0 processing_system7_0
       (.CAN0_PHY_RX(GND_1),
