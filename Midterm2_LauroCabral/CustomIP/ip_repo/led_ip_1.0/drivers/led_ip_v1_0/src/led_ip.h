...
#define LED_IP_S00_AXI_SLV_REG0_OFFSET 0
#define LED_IP_S00_AXI_SLV_REG1_OFFSET 4
#define LED_IP_S00_AXI_SLV_REG2_OFFSET 8
#define LED_IP_S00_AXI_SLV_REG3_OFFSET 12
