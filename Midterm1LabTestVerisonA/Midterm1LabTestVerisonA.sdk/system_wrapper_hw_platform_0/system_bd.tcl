...
proc create_root_design { parentCell } {
  ...
  # Create instance: led_midterm1_verisonA, and set properties
  set led_midterm1_verisonA [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 led_midterm1_verisonA ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS {0} CONFIG.GPIO_BOARD_INTERFACE {leds_4bits} CONFIG.USE_BOARD_FLOW {true}  ] $led_midterm1_verisonA
...
CONFIG.PCW_MIO_19_SLEW {<Select>} CONFIG.PCW_MIO_1_PULLUP {<Select>} \
CONFIG.PCW_MIO_1_SLEW {<Select>} CONFIG.PCW_MIO_20_IOTYPE {<Select>} \
...
CONFIG.PCW_MIO_4_SLEW {<Select>} CONFIG.PCW_MIO_50_DIRECTION {<Select>} \
...
CONFIG.PCW_MIO_53_SLEW {<Select>} CONFIG.PCW_MIO_5_SLEW {<Select>} \
CONFIG.PCW_MIO_6_SLEW {<Select>} CONFIG.PCW_MIO_8_SLEW {<Select>} \
CONFIG.PCW_MIO_9_PULLUP {<Select>} CONFIG.PCW_PRESET_BANK1_VOLTAGE {LVCMOS 1.8V} \
CONFIG.PCW_QSPI_GRP_FBCLK_ENABLE {0} CONFIG.PCW_QSPI_GRP_SINGLE_SS_ENABLE {0} \
CONFIG.PCW_QSPI_PERIPHERAL_ENABLE {0} CONFIG.PCW_SD0_GRP_CD_ENABLE {0} \
...
CONFIG.PCW_USE_M_AXI_GP0 {1}  ] $processing_system7_0
  ...
  # Create instance: pushButton_midterm1_versionA, and set properties
  set pushButton_midterm1_versionA [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 pushButton_midterm1_versionA ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {4} CONFIG.GPIO_BOARD_INTERFACE {btns_4bits} CONFIG.USE_BOARD_FLOW {true}  ] $pushButton_midterm1_versionA

  # Create instance: rst_processing_system7_0_100M, and set properties
  set rst_processing_system7_0_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_processing_system7_0_100M ]

  # Create interface connections
  connect_bd_intf_net -intf_net led_midterm1_verisonA_GPIO [get_bd_intf_ports leds_4bits] [get_bd_intf_pins led_midterm1_verisonA/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins processing_system7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins pushButton_midterm1_versionA/S_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins led_midterm1_verisonA/S_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net pushButton_midterm1_versionA_GPIO [get_bd_intf_ports btns_4bits] [get_bd_intf_pins pushButton_midterm1_versionA/GPIO]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins led_midterm1_verisonA/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins pushButton_midterm1_versionA/s_axi_aclk] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins led_midterm1_verisonA/s_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins pushButton_midterm1_versionA/s_axi_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_midterm1_verisonA/S_AXI/Reg] SEG_led_midterm1_verisonA_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pushButton_midterm1_versionA/S_AXI/Reg] SEG_pushButton_midterm1_versionA_Reg
